...
type DividerFieldProps = {
  height: "0.5" | "1" | "2" | "3" | "4";
  spaceTop: "5" | "10" | "15" | "20" | "25" | "30";
  spaceBottom: "5" | "10" | "15" | "20" | "25" | "30";
  id: string;
  index: number;
  totalFields: number;
  ...
  return (
    ...
    >
      ...
      <div className="px-1">
        ...
        >
          <div
            className="w-full bg-light-fg-muted/30 dark:bg-dark-fg-muted/30 rounded"
            style={{ height: `${height}px` }}
          />
        </div>
        <p className="text-xs opacity-50 mt-2">
          Height: {height}px | Top: {spaceTop}px | Bottom: {spaceBottom}px
        </p>
      </div>
