...
const SettingSVG: React.FC<SettingSVGProps> = ({
  className,
  size,
  width,
  height,
  ...
  const iconWidth = width ? `${width}px` : iconSize || "25px";
